            ...
            <div className="footer-15__grid">
                ...
                <section className="footer-15__panel footer-15__panel--brand at_fade_anim" data-fade-from="bottom" data-delay=".3" aria-label="Brand and services">
                    <div className="footer-15__brand-head">
                        <Link className="footer-15__brand-mark" to="/index-15" aria-label="Infin Digital home">
                            <img className="footer-15__brand-icon" src="/assets/imgs/template/logo/logo-w.svg" alt="Infin Digital" loading="lazy" />
                        </Link>
                ...
                <section className="footer-15__panel footer-15__panel--contact at_fade_anim" data-fade-from="bottom" data-delay=".4" aria-label="Contact and legal">
                    <div className="footer-15__contact-row">
                        <p className="footer-15__intro mb-0">Infin Digital is a digital agency creating impactful digital experiences. We think like strategists and execute with clarity, creativity, and performance.</p>
                        <address className="footer-15__contact mb-0">
                            <a className="footer-15__contact-line" href="tel:+2125557398">+212 to 555-7398</a>
                            <a className="footer-15__contact-line" href="mailto:hello@infindigital.net">hello@infindigital.net</a>
                    ...
                    <div className="footer-15__legal">
                        <p className="footer-15__copy mb-0">Infin Digital &copy; 2026</p>
