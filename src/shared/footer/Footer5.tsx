...
// Footer 5 - Infin Digital (light style with grid background)
                    ...
                    <div className="row g-4">
                        <div className="col-12">
                            <div className="d-flex justify-content-between">
                                ...
                                <span className="at-footer-copyright neutral-900 opacity-100">Infin Digital © 2026</span>
                            </div>
                        </div>
                        <div className="col-xxl-3 col-md-6">
                            <h4 className="mb-0 fw-medium text-decoration-underline">
                                <a href="mailto:hello@infindigital.net">hello@infindigital.net</a>
                            </h4>
                        </div>
                        ...
                        <div className="row">
                            <div className="col-12">
                                <h1 className="d-flex align-items-end justify-content-center lh-1 fz-200 mb-0 text-nowrap">
                                    ...
                                    Infin Digital <sup className="fz-80 fw-400">®</sup>
                                </h1>
                            </div>
                            <div className="col-12">
                                <div
