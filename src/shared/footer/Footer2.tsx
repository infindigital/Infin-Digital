              ...
              <div className="d-flex flex-wrap align-items-start gap-5">
                ...
                <div className="d-flex flex-column gap-3">
                  <h6 className="text-white mb-2 fw-medium">
                    <a href="tel:+918073302248" className="text-white text-decoration-none">+91 80733 02248</a>
                  </h6>
                  <h6 className="text-white mb-2">
                    <a href="mailto:contact@infindigital.in" className="text-white text-decoration-none">
          ...
          <div className="footer-2-border pt-40 pb-40">
            <div className="row align-items-end g-4">
              <div className="col-lg-10 col-md-8">
                <span className="at-footer-copyright">Infin Digital © 2026</span>
              ...
              <div className="col-lg-2 col-md-4 text-end">
                <div className="d-flex flex-wrap align-items-end gap-4 gap-md-5 mb-3">
                  <div className="footer-2-hours text-white">
                    <span className="d-block fz-font-md opacity-50">Open</span>
                    <h5 className="fw-400 common-white">24 Hours</h5>
                  </div>
                </div>
              </div>
            </div>
