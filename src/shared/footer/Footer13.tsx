        ...
        <footer className="footer-13" aria-label="Site footer">
            ...
            <div className="footer-13__body">
                <div className="footer-13__top">
                    <div className="footer-13__brand at_fade_anim" data-fade-from="bottom" data-delay=".1">
                        <Link className="footer-13__logo" to="/">
                            <img src="/assets/imgs/template/logo/favicon.svg" alt="Infin Digital" loading="lazy" />
                            <span className="footer-13__logo-text">Infin Digital</span>
                        </Link>
                ...
                <div className="footer-13__bigbrand">
                    <p className="footer-13__bigbrand-text mb-0 text-scale-anim">Infin Digital<sup>&reg;</sup> Architecture</p>
                </div>
            </div>

            <div className="footer-13__legal">
                <p className="footer-13__copy mb-0">&copy; 2026 Infin Digital Architecture, Ltd. RIBA #18472. All rights reserved.</p>
