                ...
                <div className="container-fluid px-3 px-lg-5">
                    ...
                    <div className="footer-12__columns">
                        <div className="footer-12__col footer-12__col--brand">
                            <Link className="footer-12__brand" to="/index-12" aria-label="Infin Digital home">
                                <img className="footer-12__brand-logo" src="/assets/imgs/template/logo/logo-w.svg" alt="Infin Digital" loading="lazy" />
                            </Link>
                    ...
                    <div className="footer-12__bottom">
                        <p className="footer-12__copy mb-0">&copy; 2026 Infin Digital. All rights reserved.</p>
