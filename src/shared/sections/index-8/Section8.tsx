...
const testimonials: Testimonial[] = [
    {
        ...
        role: "CTO",
        company: "NexusTech",
        quote: "\"Infin Digital doesn't just build models; he builds engines for growth. His ability to deploy complex architectures with 99.9% reliability is what sets his work apart.\"",
    ...
    },
    {
        ...
        quote: "\"Infin Digital has a rare architectural intuition, cutting legacy neural network latency by 40% while maintaining accuracy.\"",
    ...
    },
    {
        ...
        role: "Head of AI",
        company: "Synthetix Systems",
        quote: "\"With a rare gift for architecture, Infin Digital optimized our legacy neural networks, slashing latency by 40% while maintaining accuracy.\"",
    ...
    return (
        <>
            {Array.from({ length: 5 }).map((_, i) => (
                <img key={i} src="/assets/imgs/pages/home-8/sec8-star.svg" alt="Infin Digital" width={16} height={16} loading="lazy" />
            ))}
        </>
    );
}
            ...
            <div className="container-fluid sec-8-home-8__container">
                <div className="sec-8-home-8__top d-flex align-items-end justify-content-between">
                    <div className="d-flex align-items-center gap-2">
                        ...
                        <span className="sec-8-home-8__kicker-icon" aria-hidden="true">
                            <img src="/assets/imgs/pages/home-8/sec8-arrow.svg" alt="Infin Digital" width={24} height={12} loading="lazy" />
                        </span>
                    </div>
                ...
                <div className="sec-8-home-8__stage">
                    <div className="sec-8-home-8__center">
                        <img className="sec-8-home-8__asterisk at-scroll-rotate" data-rotate-duration="12" data-rotate-sensitivity="0.18" data-rotate-boost="12" src="/assets/imgs/pages/home-8/sec8-asterisk.svg" alt="Infin Digital" width={100} height={100} loading="lazy" />
                                    ...
                                    <div className="sec-8-home-8__card">
                                        ...
                                        <div className="sec-8-home-8__body">
                                            <div className="sec-8-home-8__avatar">
                                                <img src={t.avatar} alt="Infin Digital" width={80} height={80} loading="lazy" />
                                            </div>
