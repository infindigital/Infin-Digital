...
export default function Section1() {
    return (
        <section className="sec-1-home-8 p-relative overflow-hidden">
                    ...
                    <div className="col-xl-6 h8-col-right">
                        <div className="h8-photos d-flex align-items-start">
                            <div className="h8-photo-box anim-zoomin-wrap" scroll-parallax-range="228" data-h8-parallax-ease="sine.inOut">
                                <img className="anim-zoomin" src="/assets/imgs/pages/home-8/hero8-img-1.webp" alt="Infin Digital" width={500} height={600} loading="lazy" />
                            </div>
                            <div className="h8-photo-box h8-photo-down anim-zoomin-wrap" scroll-parallax-range="110" data-h8-parallax-ease="power3.in">
                                <img className="anim-zoomin" src="/assets/imgs/pages/home-8/hero8-img-2.webp" alt="Infin Digital" width={500} height={600} loading="lazy" />
                            </div>
                            <div className="h8-photo-box anim-zoomin-wrap" scroll-parallax-range="52" data-h8-parallax-ease="sine.inOut">
                                <img className="anim-zoomin" src="/assets/imgs/pages/home-8/hero8-img-3.webp" alt="Infin Digital" width={500} height={600} loading="lazy" />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            {/* ============================================================
                 BOTTOM BAND: Oversized "INFIN DIGITAL® / STUDIO" type with portrait
            ============================================================ */}
            <div className="h8-bottom-band">
                <p className="h8-big-title">
                    <span className="h8-word text-scale-anim">INFIN DIGITAL</span><sup className="h8-registered">&#174;</sup>
                    <span className="h8-portrait-frame">
                        <img src="/assets/imgs/pages/home-8/hero8-img-8.gif" alt="Infin Digital" width={120} height={120} loading="lazy" />
                    </span>
                ...
                <div className="h8-bottom-meta d-flex align-items-center justify-content-between">
                    <span className="h8-meta-text text-scramble" data-scramble-text="hello@infindigital.net">hello@infindigital.net</span>
