                                    ...
                                    <div className="at-service-img-wrapper image-container sec-4-home-8__img-stack">
                                        {hoverImages.map((img, index) => (
                                            <div className="hover-image" key={`hover-${index}`}>
                                                <img className="thumb" src={img} alt="Infin Digital" width={500} height={400} loading="lazy" />
                                            </div>
                                        ))}
                                    </div>
                            ...
                            <Link to="/services-details">
                                <div className="at-service-item service-item active">
                                    ...
                                    <div className="thumb anim-zoomin">
                                        <img data-speed=".9" src="/assets/imgs/pages/home-8/hero8-sec4-hover-1.webp" alt="Infin Digital" width={300} height={200} loading="lazy" />
                                    </div>
                                </div>
                            </Link>
                            <Link to="/services-details">
                                <div className="at-service-item service-item">
                                    ...
                                    <div className="thumb anim-zoomin">
                                        <img src="/assets/imgs/pages/home-8/hero8-sec4-hover-2.webp" alt="Infin Digital" width={300} height={200} loading="lazy" />
                                    </div>
                                </div>
                            </Link>
                            <Link to="/services-details">
                                <div className="at-service-item service-item">
                                    ...
                                    <div className="thumb anim-zoomin">
                                        <img data-speed=".9" src="/assets/imgs/pages/home-8/hero8-sec4-hover-3.webp" alt="Infin Digital" width={300} height={200} loading="lazy" />
                                    </div>
                                </div>
                            </Link>
                            <Link to="/services-details">
                                <div className="at-service-item service-item">
                                    ...
                                    <div className="thumb anim-zoomin">
                                        <img data-speed=".9" src="/assets/imgs/pages/home-8/hero8-sec4-hover-4.webp" alt="Infin Digital" width={300} height={200} loading="lazy" />
                                    </div>
                                </div>
                            </Link>
