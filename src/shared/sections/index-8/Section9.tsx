                        ...
                        <div className="sec-9-home-8__content">
                            ...
                            <div className="sec-9-home-8__cta at_fade_anim">
                                ...
                                <Link className="sec-9-home-8__cta-icon" to="/contact-1" aria-label="Start your design journey">
                                    <img src="/assets/imgs/pages/home-8/sec9-btn-icon.svg" alt="Infin Digital" width={48} height={48} loading="lazy" />
                                </Link>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="col-xl-5">
                        <Link className="sec-9-home-8__card" to="/contact-1" aria-label="Contact us">
                            <div className="sec-9-home-8__card-media">
                                <img className="sec-9-home-8__card-visors w-100 scale-img-from-to" data-value-1="1.5" data-value-2="1" src="/assets/imgs/pages/home-8/sec9-card-visors.webp" alt="Infin Digital" width={500} height={350} loading="lazy" />
                            </div>
                            <div className="sec-9-home-8__card-overlay">
                                <span className="sec-9-home-8__card-kicker">
                                    <span>Contact us</span>
                                    <img src="/assets/imgs/pages/home-8/sec9-arrow.svg" alt="Infin Digital" width={16} height={16} loading="lazy" />
                                </span>
