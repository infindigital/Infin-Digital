                    ...
                    >
                        {rail1Images.map((src, i) => (
                            <div key={`r1-${i}`} className="about-me-slider-thumb at-item-anime marque">
                                <img className="w-100 rounded-4" src={src} alt="Infin Digital" width={600} height={400} loading="lazy" />
                            </div>
                        ))}
                    </SwiperDynamic>
                </div>
            ...
            <div className="container-fluid sec-7-home-8__container">
                <div className="sec-7-home-8__about d-flex align-items-start gap-4 at_fade_anim">
                    ...
                    <p className="sec-7-home-8__desc mb-0">
                        <span className="fw-600 reveal-text"><RevealText>Infin Digital is a digital agency creating impactful digital experiences. We think like strategists and execute with clarity, creativity, and performance.</RevealText></span>
                    </p>
                </div>
            </div>
        </section>
