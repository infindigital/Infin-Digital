...
export default function Section1() {
    ...
    return (
        <section className="sec-1-home-13 pt-160" aria-label="Infin Digital Architecture Hero">
                            ...
                            {SERVICES.map((srv, i) => (
                                <button key={i} type="button" className="swiper-slide sec-1-home-13__service" aria-label={`View ${srv.name}`}>
                                    <span className="sec-1-home-13__service-img">
                                        <img src={`/assets/imgs/pages/home-13/${srv.icon}`} alt="Infin Digital" loading="lazy" />
                                    </span>
