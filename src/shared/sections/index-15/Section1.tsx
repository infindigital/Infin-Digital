        ...
        <section className="sec-1-home-15 pt-100" aria-label="Agency hero">
            <div className="container">
                <div className="sec-1-home-15__card ripple-image ripples">
                    <img className="sec-1-home-15__bg" src="/assets/imgs/pages/home-15/sec-1-hero.webp" alt="Infin Digital" fetchPriority="high" loading="lazy" />
                    ...
                    <div className="sec-1-home-15__top">
                        ...
                        <a className="sec-1-home-15__email at_fade_anim text-white" data-fade-from="top" data-delay=".3" href="mailto:hello@infindigital.net">hello@infindigital.net</a>
                    </div>
                    ...
                    <div className="sec-1-home-15__bottom">
                        ...
                        <div className="sec-1-home-15__clients at_fade_anim" data-fade-from="bottom" data-delay=".4">
                            <div className="sec-1-home-15__avatars" aria-hidden="true">
                                {[1, 2, 3, 4, 5].map((n) => (
                                    <img key={n} className="sec-1-home-15__avatar" src={`/assets/imgs/pages/home-15/sec-1-avatar-${n}.webp`} alt="Infin Digital" loading="lazy" />
                                ))}
                            </div>
