...
export default function Section2() {
    return (
        <section className="sec-2-home-15 pt-100 pb-100" aria-label="About Infin Digital">
                ...
                <div className="row gx-4 gy-4">
                    <div className="col-xxl-5 col-xl-6 col-lg-6">
                        <div className="sec-2-home-15__media-1 anim-zoomin-wrap">
                            <img className="sec-2-home-15__media-1-img anim-zoomin" src="/assets/imgs/pages/home-15/sec-2-img-1.webp" alt="Infin Digital" loading="lazy" />
                ...
                <div className="row gx-4 gy-5 mt-30 align-items-center">
                    ...
                    <div className="col-xxl-3 col-xl-3 col-lg-6 col-md-6">
                        <div className="sec-2-home-15__media-2 anim-zoomin-wrap">
                            <img className="sec-2-home-15__media-2-img anim-zoomin" src="/assets/imgs/pages/home-15/sec-2-img-2.webp" alt="Infin Digital" loading="lazy" />
                    ...
                    <div className="col-xxl-3 col-xl-3 col-lg-6 col-md-6">
                        <div className="sec-2-home-15__statement at_fade_anim" data-fade-from="bottom" data-delay=".3">
                            <img className="sec-2-home-15__statement-icon" src="/assets/imgs/pages/home-15/sec-2-shape-25.svg" alt="Infin Digital" loading="lazy" />
