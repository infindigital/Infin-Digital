...
const QUOTES = [
    "Infin Digital didn't just build us a website; they engineered a digital experience that mirrors our ambition. The integration of GSAP motion and high-performance code has set a new benchmark in our industry. Truly the modern standard.",
    "Working with Infin Digital changed how our brand shows up online. Every interaction feels intentional, every page tells our story, and the result is a site that converts as beautifully as it looks.",
    ...
    "We arrived with a vague vision and left with a digital platform that outperforms our wildest projections. Infin Digital is the rare studio that thinks like strategists and builds like senior engineers.",
    "Three months after launch, our traffic is up eighty percent, time on site has tripled, and the press has not stopped reaching out. Hiring Infin Digital was the highest-leverage decision we made this year.",
];
