...
export default function Section6() {
    ...
    return (
        <section className="sec-6-home-12 changeless" aria-label="About Infin Digital">
            <div className="sec-6-home-12__topbar">
                ...
                <div className="container-fluid px-3 px-lg-5">
                    <div className="sec-6-home-12__topbar-row">
                        ...
                        <span className="sec-6-home-12__topbar-label">&copy; <span className="text-scramble">2012</span> Infin Digital</span>
                    </div>
                </div>
            </div>
                    ...
                    <div className="swiper-wrapper">
                        {slides.map((n, i) => (
                            <div key={i} className="swiper-slide sec-6-home-12__brand-slide">
                                <img className="sec-6-home-12__brand-img" src={`/assets/imgs/pages/home-12/sec-6-brand-${n}.svg`} alt="Infin Digital" loading="lazy" />
                            </div>
                        ))}
                    </div>
                </div>
