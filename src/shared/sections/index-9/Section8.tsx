...
const testimonials = [
    {
        ...
        quote: "Infin Digital didn't just build us a website; they engineered a digital experience that mirrors our ambition. The integration of GSAP motion and high-performance code has set a new benchmark in our industry. Truly the modern standard.",
        name: "Amelia Wright",
    ...
    },
    {
        ...
        quote: "Scalability was our biggest concern, but Infin Digital delivered a design system that is both flexible and robust. They are more than an agency; they are strategic partners who understand the pulse of the modern digital landscape.",
        name: "Marcus Thorne",
                                ...
                                <div className="testimonial-content">
                                    ...
                                    <div className="testimonial-author">
                                        <div className="author-logo">
                                            <img src={item.logo} alt="Infin Digital" width={80} height={30} loading="lazy" />
                                        </div>
