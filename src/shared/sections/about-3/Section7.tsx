...
const FAQ_ITEMS = [
    {
        ...
        answer: "Discovery, sitemap, design, build and testing on real devices, then launch. You approve each stage.",
        open: true,
    },
    {
        id: "collapseTwo",
        ...
        answer: "Scope decides it. A business site moves faster than e-commerce. We agree a schedule at kickoff.",
        open: false,
    },
    {
        id: "collapseThree",
        ...
        answer: "Retail, restaurants, clinics, real estate, education and manufacturing across Dakshina Kannada.",
        open: false,
    },
    {
        id: "collapseFour",
        ...
        answer: "Yes, we build on editable systems and run a handover session so you are fully in control.",
        open: false,
    },
];
