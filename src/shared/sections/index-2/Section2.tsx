...
// The in/fin slash — the company mark, matching the slant and weight of the logo.
const SLASH_SVG = (
    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40 40" fill="none" role="img" aria-label="Infin Digital">
        <path d="M23.2 4H27.2L16.8 36H12.8L23.2 4Z" fill="#B7B7B7" />
    </svg>
);
                        ...
                        <div className="col-xxl-3 col-lg-4 col-md-7 tp_fade-anim">
                            ...
                            >
                                <div className="card-item__bg">
                                    <img
                                        src="/assets/imgs/pages/img-29.jpg"
                                        alt="Designer sketching website layout wireframes by hand in a notebook at a desk"
                                        className="home-2-card-item__bg-img img-cover"
                                        width={1080}
                                        height={1444} loading="lazy" />
                                </div>
