// Showreel video URL. Leave empty until the real film is published — the play
// button then renders as artwork only, with nothing to click.
const SHOWREEL_URL = "";
                        ...
                        <div className="postbox-thumb p-relative rounded-5">
                            ...
                            <div className="postbox-play-btn postbox-scroll-zoom-play z-index-1 d-flex align-items-center justify-content-center gap-3">
                                ...
                                {SHOWREEL_URL ? (
                                    ...
                                    <span className="text-white" aria-hidden="true">{PLAY_SVG}</span>
                                )}
