...
const FAQ_ITEMS = [
    {
        ...
        answer: "We offer web design and development, e-commerce development, SEO, digital marketing, performance marketing, and branding.",
        open: true,
    },
    {
        id: "collapseTwo",
        ...
        answer: "Most website projects take 3 to 6 weeks from kickoff to launch, depending on scope and complexity.",
        open: false,
    },
    {
        id: "collapseThree",
        ...
        answer: "Yes — we're based in Mangalore but work with clients across India and welcome remote collaborations.",
        open: false,
    },
    {
        id: "collapseFour",
        ...
        answer: "We work on project-based pricing tailored to your needs. Contact us for a custom quote.",
        open: false,
    },
    {
        id: "collapseFive",
        ...
        answer: "Absolutely — we build on user-friendly platforms and provide handover training so you're fully in control.",
        open: false,
    },
];
                        ...
                        <div className="alt-faq-title-wrap mb-40">
                            <div className="rounded-4 overflow-hidden anim-zoomin">
                                <img
                                    ...
                                    height={700}
                                    className="w-100"
                                    alt="Infin Digital" loading="lazy" />
                            </div>
