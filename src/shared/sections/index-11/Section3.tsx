                ...
                <div className="row align-items-end">
                    ...
                    <div className="col-lg-5">
                        <p className="mb-0 at_fade_anim" data-delay=".25" data-fade-from="right">
                            Founded in 2019, Infin Digital Motion is an independent creative studio specialising in branded film, motion design, and visual effects. We work with challenger brands, cultural institutions, and Fortune 500 companies to craft stories that move people -- literally.
                        </p>
                    </div>
                </div>
                        ...
                        <div className="sec-3-home-11__media-a at_fade_anim" data-delay=".1" data-fade-from="left">
                            <div className="anim-zoomin-wrap sec-3-home-11__img-frame sec-3-home-11__img-frame--tall">
                                <img
                                    ...
                                    alt="Infin Digital studio workspace"
                                    width={800}
                                    height={1100}
                                    loading="lazy"
                                    decoding="async"
                        ...
                        <div className="sec-3-home-11__side at_fade_anim" data-delay=".15" data-fade-from="right">
                            <div className="anim-zoomin-wrap sec-3-home-11__img-frame sec-3-home-11__img-frame--sq">
                                <img
                                    ...
                                    alt="Infin Digital team at work"
                                    width={600}
                                    height={700}
                                    loading="lazy"
                                    decoding="async"
