                        ...
                        <div className="row g-xxl-5 g-4">
                            <div className="col-xxl-5 col-lg-12 col-md-5 col-12 d-lg-none d-xxl-block">
                                <div className="img-left ripple-image ripples">
                                    <img src="/assets/imgs/pages/img-56.webp" alt="Infin Digital" width={325} height={335} className="img-cover" loading="lazy" />
                                </div>
                            </div>
                            <div className="col-xxl-7 col-lg-12 col-md-7 col-12">
                                <div className="d-flex flex-column gap-3">
                                    ...
                                    <div className="img-right">
                                        <img src="/assets/imgs/pages/img-57.webp" alt="Infin Digital" width={470} height={350} loading="lazy" />
                                    </div>
                                </div>
                            </div>
                        </div>
