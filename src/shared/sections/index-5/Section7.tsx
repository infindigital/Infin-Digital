...
const TESTIMONIALS: TestimonialItem[] = [
    ...
    },
    {
        ...
        quote:
            '"Infin Digital possesses a rare architectural intuition. He successfully optimized our legacy neural networks, reducing latency by 40% without compromising on model accuracy."',
        headerFirst: true,
                    ...
                    <div className="col-xxl-5 col-md-8 ms-xxl-auto">
                        <div className="d-flex align-items-center gap-5 justify-content-xxl-end">
                            ...
                            <div>
                                ...
                                <h6 className="fw-600">
                                    <Link to="mailto:hello@infindigital.net">hello@infindigital.net</Link>
                                </h6>
                            </div>
                        </div>
                    </div>
