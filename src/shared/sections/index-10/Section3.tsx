                ...
                <header className="sec-3-home-10__header row g-4 g-xl-5 align-items-end justify-content-between">
                    ...
                    <div className="col-xl-5 col-lg-6">
                        <p className="sec-3-home-10__intro mb-0 at_fade_anim reveal-text" data-delay="0.15">
                            <RevealText>
                                <strong>Infin Digital</strong> is more than a design agency; we are a strategic partner for founders who dare to disrupt. We <strong>combine rapid</strong> prototyping with world-class engineering to <strong>turn bold</strong> visions into market-leading digital products.
                            </RevealText>
                        </p>
                    </div>
                </header>
