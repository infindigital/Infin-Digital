                        ...
                        <div className="sec-4-home-7__locations row g-4 g-lg-5">
                                ...
                                <div className="d-flex gap-4">
                                    ...
                                    <div className="flex-grow-1 min-w-0">
                                        ...
                                        <div className="sec-4-home-7__loc-body at_fade_anim">
                                            ...
                                            <p className="mb-0">
                                                Email:{" "}
                                                <a href="mailto:hello@infindigital.net" className="sec-4-home-7__loc-strong">hello@infindigital.net</a>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="col-lg-6 col-12">
                                <div className="sec-4-home-7__loc-body sec-4-home-7__loc-body--solo ps-lg-4 at_fade_anim">
                                    ...
                                    <p className="mb-0">
                                        Email:{" "}
                                        <a href="mailto:sale@infindigital.net" className="sec-4-home-7__loc-strong">sale@infindigital.net</a>
                                    </p>
                                </div>
                            </div>
                        </div>
